 ...
 <div class="col-xl-14 mb-3">
 	<div class="card text-black o-hidden h-100" style="background-color:#e9ecef;">
    	<div class="card-body">
			...
			<div class="mr-5">Maquinaria / <a href="<?= base_url();?>maquinas/" style="color:black;">Nueva Maquina</a></div>
        </div>
	</div>
 </div>
...
<!--tabla de usuarios -->
      ...
      <div class="card-header">Datos de la nueva Maquina</div>
      <div class="card-body">
        <?php  echo form_open('maquinaria/guardaMaquinaNueva');?>
          ...
          <div class="form-group">
            <div class="form-row">
			  ...
			  <input name="tipo" type="text" class="form-control" id="exampleInputName" placeholder="" value="" aria-describedby="nameHelp">	
              </div>
				<div class="col-md-3">
